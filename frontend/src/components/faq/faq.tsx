    ...
    <>
      <section id="intro" className="w-full *:m-0">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
          ...
          means that there's a 66% - or 2/3 for you math gurus - chance of rain
          in your area.
        </p>
      ...
      <section id="what-do-i-post" className="w-full">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
          Pictures of your cat. I feel like you should have been able to figure
          that out on your own, but I'm not here to judge.
        </p>
      </section>
        ...
        <div id="pic-details-wrap" className="w-full">
          <div id="pic-details" className="w-full">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
              ...
              photo on Purrcast to help others devolve back to their monolithic
              roots, you must make sure your cat is asleep in the photo.
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
              ...
              that. Although the systems are there, please do your due diligence
              and make sure your cat is asleep in the photo before posting.
              Please report any photos that are not of sleeping cats.
            </p>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
              As already mentioned, the means for us predicting what the weather
              will be like is solely based on whether a cat is sleeping on it's
              head or not. You may confused as to what we consider a cat
              sleeping on it's head, so please refer to the examples below for
              the 3 types of sleeping cats we consider:
            </p>
          </div>
          <div
      ...
      <section id="what-kind-of-cat-pics" className="w-full">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
          ...
          usually a few seconds after the submission of the post. This column is
          a true or false value that indicates whether the cat in the photo is
          laying on their head or not. This logic is handled by... you guessed
          it, ARTIFICIAL INTELLIGENCE.
        </p>
        <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
          We utilize this special column to then comb through all the posts from
          within the user's radius, keeping track of how many have the special
          column set to true. We finally divide that sum of posts where the cat
          is laying on it's head by the total number of posts within the user's
          radius to get a percentage.
        </p>

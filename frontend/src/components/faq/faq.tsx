export default function faq() {
  return (
    <>
      <section className="flex flex-col flex-auto place-items-center w-5/6 sm:w-5/6 max-w-screen-md space-y-10 my-5 py-5">
        <section id="intro" className="w-full *:m-0">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            ...
            prediction app, taking rolling averages of the amount of cats laying
            on their heads in your area to determine if it's going to rain soon.
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            For example, imagine 3 of your friends (or just randos) have posted
            images of their cats sleeping in your area.
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            Of those 3 sleepings cats, 2 of them are laying on their heads. This
            means that there's a 66% - or 2/3 for you math gurus - chance of
            rain in your area.
          </p>
        ...
        <section id="what-do-i-post" className="w-full">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            Pictures of your cat. I feel like you should have been able to
            figure that out on your own, but I'm not here to judge.
          </p>
        </section>
          ...
          <div id="pic-details-wrap" className="w-full">
            <div id="pic-details" className="w-full">
              ...
              <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
                ...
                That is, pictures of sleeping cats only! If you decide to post a
                photo on Purrcast to help others devolve back to their
                monolithic roots, you must make sure your cat is asleep in the
                photo. Otherwise, it will taint the data!
              </p>
              <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
                We do have systems in place to try to keep people from posting a
                photo of a cat if the cat is not asleep in the image, but we are
                actually legally obligated to tell you that the creator of this
                site has an IQ less than 96, so we can't put too much trust into
                that. Although the systems are there, please do your due
                diligence and make sure your cat is asleep in the photo before
                posting. Please report any photos that are not of sleeping cats.
              </p>
              ...
              <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
                As already mentioned, the means for us predicting what the
                weather will be like is solely based on whether a cat is
                sleeping on it's head or not. You may confused as to what we
                consider a cat sleeping on it's head, so please refer to the
                examples below for the 3 types of sleeping cats we consider:
              </p>
            </div>
            <div
            ...
            >
              <div className="sm:w-3/4 md:w-1/2">
                ...
                >
                  <img
                    src="https://cdn2.thecatapi.com/images/6d0.jpg"
                    alt="bad example 1"
                    className="w-full h-full row-span-2 col-span-1 rounded-md"
                  />
                  <img
                    src="https://cdn2.thecatapi.com/images/efs.jpg"
                    alt="bad example 2"
                  ...
                  />
                  <img
                    src="https://cdn2.thecatapi.com/images/aag.jpg"
                    alt="bad example 4"
                    className="w-full h-full row-span-2 col-span-2 rounded-md"
                  />
                  <img
                    src="https://cdn2.thecatapi.com/images/a6u.jpg"
                    alt="bad example 5"
                    className="w-full h-full row-span-1 col-span-1 rounded-md"
                  />
        ...
        <section id="what-kind-of-cat-pics" className="w-full">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            ...
            grabbing their location. If there are gracious enough to allow us to
            use their location, we will then make a request to our backend to
            search for all posts within a certain radius of the user's location.
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            We store each cat post with a special column that gets generated
            usually a few seconds after the submission of the post. This column
            is a true or false value that indicates whether the cat in the photo
            is laying on their head or not. This logic is handled by... you
            guessed it, ARTIFICIAL INTELLIGENCE.
          </p>
          <p className="leading-7 [&:not(:first-child)]:mt-6 break-words">
            We utilize this special column to then comb through all the posts
            from within the user's radius, keeping track of how many have the
            special column set to true. We finally divide that sum of posts
            where the cat is laying on it's head by the total number of posts
            within the user's radius to get a percentage.
          </p>

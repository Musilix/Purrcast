...
export default function NonUserHome() {
  ...
  return (
    <>
      <div id="non-user-home-wrap" className="relative w-full h-full m-0 p-0">
        <div className="absolute w-full h-full m-0 p-0 top-0 left-0 -z-10 flex flex-col justify-center items-center align-middle blur-3xl">
          <div className="w-3/4 h-1/2 bg-teal-600/80 rounded-full"></div>
        </div>
        <div>
          <h1 className="bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-blue-400 text-outline text-center font-bold leading-tight tracking-tighter text-5xl md:text-6xl lg:leading-[1.1] md:block">
        ...
        >
          ...
          <Card className="z-10 w-full md:w-full p-6 m-t-[200px] max-w-[500px] min-w-[300px] text-center">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6 break-keep">
              ...
              centralized place for you to post and look at photos of peoples
              cats in your area to determine if it's going to rain soon or maybe
              just drizzle.
            </p>
          </Card>
        </div>
